...
public class RegisterPage extends SetupDriver{
	...
	public By user_name_field_registration = (By.xpath("//table[@class='form2']//descendant::input[@id='customer.username']"));
	
	//registration form password field
	public By password_field_registration = (By.xpath("//table[@class='form2']//descendant::input[@id='customer.password']"));
